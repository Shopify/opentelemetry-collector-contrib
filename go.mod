...
replace github.com/open-telemetry/opentelemetry-collector-contrib => github.com/Shopify/opentelemetry-collector-contrib v0.42.1-0.20220128170523-5f3bf9e0c1d2
