...
// OCToMetrics converts OC data format to data.MetricData.ƒ
// Deprecated: use pdata.Metrics instead. OCToMetrics may be used only by OpenCensusÏ
// receiver and exporter implementations.Ï
